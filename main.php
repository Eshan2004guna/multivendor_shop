        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <?php if ($role === "seller") { ?>
                ...
                <a href="seller/add_product.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-green-400 to-emerald-600 hover:scale-105 transition">
                ...
                <a href="seller/orders.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-blue-500 to-indigo-600 hover:scale-105 transition">
                    ...
                    <p>See and manage customer orders.</p>
                </a>
            ...
            <?php if ($role === "customer") { ?>
                ...
                <a href="customer/products.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-blue-500 to-cyan-500 hover:scale-105 transition">
                    <h3 class="text-2xl font-bold mb-2">View Products</h3>
                    <p>Browse products from sellers.</p>
                </a>

                <a href="customer/cart.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-purple-500 to-pink-500 hover:scale-105 transition">
                    <h3 class="text-2xl font-bold mb-2">My Cart</h3>
                    <p>Check your selected items.</p>
                </a>

                <a href="customer/checkout.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-emerald-500 to-green-600 hover:scale-105 transition">
            ...
            <?php if ($role === "admin") { ?>
                ...
                <a href="admin/dashboard.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-indigo-500 to-blue-700 hover:scale-105 transition">
                    <h3 class="text-2xl font-bold mb-2">Admin Dashboard</h3>
                    <p>Overview of system activity.</p>
                </a>

                <a href="admin/manage_users.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-pink-500 to-rose-600 hover:scale-105 transition">
                    <h3 class="text-2xl font-bold mb-2">Manage Users</h3>
                    <p>Control registered users.</p>
                </a>

                <a href="admin/manage_products.php"
                   class="rounded-3xl p-6 text-white shadow-xl bg-gradient-to-r from-slate-600 to-slate-800 hover:scale-105 transition">
                    <h3 class="text-2xl font-bold mb-2">Manage Products</h3>
